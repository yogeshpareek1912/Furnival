...
?>
   ...
   <div class="row">
    ...
    <select name="emp_name"class="form-control" onChange="myFunction()" id="emp_n">
   ...
   <div class="row">
    ...
    <select name="state" class="form-control" id="state" name="basicsal">
				  ...
				  <div class="row">
					...
					<div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"   id = "gross_amount" name="grossssal" readonly>
                   	 </div>
                    </div>  
				  </div>
                  ...
                  <div class="row">
					...
					<div class="col-md-2 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"    id = "texamount" name="taxmat" readonly>
                   	 </div>
                    </div>
				  </div>      
					...
					<div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"    id = "final_salary" name ="net_salary" readonly>
                   	 </div>
                    </div>  
				  </div>
...
<button type = "button"  class="btn btn--radius-2 btn--blue"  id = "newsalary">Generate Salary</button><br><br>
